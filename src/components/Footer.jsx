...
export default function Footer() {
  return (
    <footer className="mx-auto w-full max-w-6xl px-4 py-8 text-[0.85rem] text-slate-500 sm:px-8 lg:px-12">
      <div className="flex flex-col gap-4 rounded-[1.5rem] border border-white/70 bg-white/55 px-5 py-6 shadow-[0_20px_45px_rgba(15,23,42,0.06)] backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <div className="mono flex items-center gap-2 text-slate-900">
            <Terminal className="h-4 w-4 text-slate-500" />
            Andy 個人作品集
          </div>
          <div>作品集 / 專案整理 / 筆記想法</div>
        </div>
